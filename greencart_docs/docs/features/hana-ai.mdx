...
<div style={{display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', margin: '1.5rem 0'}}>
  <div style={{textAlign: 'center'}}><img src="/greencart/img/screenshots/hana_ai.png" alt="AI Assistant" width={280} /><br/><em>AI Chat</em></div>
  <div style={{textAlign: 'center'}}><img src="/greencart/img/screenshots/hana_ai_voice.png" alt="AI Voice Input" width={280} /><br/><em>Voice Input</em></div>
</div>
...
<div style={{display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', margin: '1.5rem 0'}}>
  <div style={{textAlign: 'center'}}><img src="/greencart/img/screenshots/hana_ai_voice.png" alt="Voice Input" width={280} /><br/><em>Voice Input</em></div>
</div>
...
<div style={{display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', margin: '1.5rem 0'}}>
  <div style={{textAlign: 'center'}}><img src="/greencart/img/screenshots/ai_product_card.png" alt="AI Product Card" width={280} /><br/><em>AI Product Card</em></div>
</div>
