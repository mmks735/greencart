...
[![Screens](https://img.shields.io/badge/Screens-26+-orange?style=for-the-badge)](#-ui-showcase--screen-galleries)
  ...
  <tr>
    ...
    <td valign="middle" style="border: none; padding-left: 24px;">
      ...
      <a href="https://mmks735.github.io/greencart/">
        <img src="https://img.shields.io/badge/Explore_Interactive_Docs-Click_Here-success?style=for-the-badge" alt="Docs"/>
      </a>
    </td>
  </tr>
</table>
...
| AI Home Entry | Conversational AI Feed | Speech-to-Text Voice Mode | Direct AI Product Card |
| :---: | :---: | :---: | :---: |
...
| Real-time Tracking Stepper | Order History | Saved Addresses | Notification Center |
| :---: | :---: | :---: | :---: |
...
| User Login | Account Registration | OTP Verification | Set New Password |
| :---: | :---: | :---: | :---: |
| <img src="./assets/screenshots/greencart/login.png" width="180"/> | <img src="./assets/screenshots/greencart/register.png" width="180"/> | <img src="./assets/screenshots/greencart/otp.png" width="180"/> | <img src="./assets/screenshots/greencart/new_password.png" width="180"/> |
...
### 1. System Architecture & State Management (GetX)
* Structured the codebase using **Clean / Feature-First Architecture** to isolate business rules from presentation and networking logic.
* Implemented **GetX Controllers & Bindings** for reactive state handling across cart calculations, authentication states, product filtering, and dynamic voucher discounts.
