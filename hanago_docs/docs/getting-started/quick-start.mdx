...
<ZoomableImage src="/img/screenshots/installation/vscode_open_project.png" alt="Opening the project in VS Code" width={500} />
...
<img src="/img/screenshots/installation/flutter_pub_get.png" alt="flutter pub get output" width="600" />
...
<img src="/img/screenshots/installation/vscode_run_debug.png" alt="Run and Debug panel" width="900" />
...
<div style={{textAlign: 'center', marginTop: '1.5rem', marginBottom: '0.5rem'}}>
  ...
  <img src="/img/screenshots/installation/app_running.png" alt="GreenCart running on device" width="280" />
</div>
